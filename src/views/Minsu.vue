<template>
    <div id="content">
        <div class="banner-ld" ng-controller="clgkbanner">
            <img src="https://ts-1305062858.cos-website.ap-nanjing.myqcloud.com/pic15.png" width="100%">
        </div>
        <!--<div class="ui" id="address">
            <div class="mainbox-ld"  ng-controller="clls">
                <div class="title-ld">
                    <div class="title-1">地方方言</div>
                </div>
                <div class="text-ld">
                    <div class="imgvideo">
...
<style scoped>
    ...
    .te{width:300px  !important; font-size:18px !important; margin-bottom:25px  !important; }
